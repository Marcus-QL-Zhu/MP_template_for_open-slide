...
export const design: DesignSystem = {
  ...
  fonts: {
    ...
    body: "Aptos, 'Microsoft YaHei', 'PingFang SC', 'Noto Sans CJK SC', system-ui, sans-serif",
  },
...
const Eyebrow = ({ children }: { children: ReactNode }) => (
  ...
  >
    <span aria-hidden style={{ width: 28, height: 3, background: palette.primary }} />
    {children}
  </div>
);
  ...
  >
    ...
    <div
      ...
      style={{
        ...
        height: 340,
        borderRadius: '50%',
        border: `72px solid ${palette.primary}`,
    ...
    >
      ...
      >
        <div>
          ...
          >
            <Swatch name="Deep purple" value="#22174E" color={palette.heading} />
            <Swatch name="Electric violet" value="#6864FF" color={palette.primary} />
            <Swatch name="Mint" value="#ABF3AB" color={palette.mint} />
            <Swatch name="Sky cyan" value="#8FE9FF" color={palette.cyan} />
            <Swatch name="Orchid" value="#E19FFF" color={palette.orchid} />
            <Swatch name="Coral" value="#FF7061" color={palette.coral} />
          </div>
        </div>
        <p style={{ margin: 0, fontSize: 30, lineHeight: 1.45, color: palette.text }}>
          Use deep purple for authority, electric violet for navigation, and the supporting colours
          only as precise signals in charts, processes, and proof points.
        </p>
      </section>
    </main>
  ...
  return (
    <div
      style={{
        ...
        border: `2px solid ${active ? palette.primary : palette.rule}`,
        display: 'flex',
        alignItems: 'center',
...
const ProcessNote = ({ title, body }: { title: string; body: string }) => (
  ...
  >
    <h3 style={{ margin: 0, fontSize: 28, lineHeight: 1.25, color: palette.heading }}>{title}</h3>
    <p style={{ margin: '14px 0 0', fontSize: 23, lineHeight: 1.5, color: palette.text }}>{body}</p>
  </div>
);
      ...
      <section style={{ position: 'relative', width: 640, height: 640 }}>
        <div
          ...
          style={{
            ...
            height: 416,
            borderRadius: '50%',
            border: `54px solid ${palette.mint}`,
